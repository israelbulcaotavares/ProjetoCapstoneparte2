...
import com.example.mechatronicse.projetocapstoneparte2.activity.MainActivity;
...
public class NotificationUtils {
    ...
    public static void createNotification(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder =
                ...
                .setContentTitle(context.getString(R.string.adotou_animal))
                .setContentText(context.getString(R.string.postagens_notifications))
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        context.getString(R.string.postagens_notifications)))
